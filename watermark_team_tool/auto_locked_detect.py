...
def _grid_candidates(width, height, box_w_fracs=(0.12, 0.16, 0.20, 0.25, 0.30), box_h_fracs=(0.08, 0.11, 0.15, 0.20, 0.25)):
    """
    Generates candidate watermark-sized boxes positioned in the four
    corners and edge-centers of the frame, at a few plausible sizes.
    Watermarks are virtually always corner/edge-anchored, so we don't
    bother scanning the center of the frame.
    """
    candidates = []
